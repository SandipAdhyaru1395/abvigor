        ...
        <div class="admin container-fluid py-2">
            ...
            <div class="admin main-content p-4">
                <div class="orders-card">
                    ...
                    <form class="mb-3" action="{{ route('admin.catalog.category.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <div class="row mt-4 align-items-center">
                            ...
                            <div class="col-md-4 text-md-end">
                                <a href="{{ route('admin.catalog.category.delete', $catalog_category->id) }}"
                                    class="btn btn-sm btn-danger" id="delete-catalog-category">Delete Category</a>
                            </div>
                        </div>
            </form>
                </div>
