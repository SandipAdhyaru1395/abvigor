...
@section('content')
    <div class="admin container py-2">
        ...
        <div class="admin main-content p-4 table-responsive">
            <table id="products-table" class="table table-hover table-responsive table-striped table-bordered">
                <thead>
                    <tr>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var table_top_left_html = `<div class="row mb-4">
                    <div class="col">
                        <a href="{{ route('admin.catalog.product.add') }}"><button class="btn btn-sm bg-primary text-white">Create</button></a>
            ...
            var table = $('#products-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('admin.get.catalog.products') }}',
                },
                dom: `
                        <"row mb-3"
            ...
            $(document).on('click', '#delete-selected', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ route('admin.catalog.products.delete') }}',
                            method: 'POST',
                            data: {
                                ids: ids,
                                _token: '{{ csrf_token() }}'
            ...
            $('#products-table tbody').on('click', 'tr td:not(:first-child)', function () {
                ...
                window.location.href = '{{ route('admin.catalog.product.edit', ':id') }}'.replace(':id', id);
            });
