        ...
        <div class="admin container-fluid py-2">
            ...
            <div class="admin main-content p-4">
                <div class="orders-card">
                    ...
                    <form class="mb-3" id="product-form" action="{{ route('admin.catalog.product.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="col-lg-6 mt-3">
                        <label for="brand" class="form-label align-self-end">Category : <span
                                class="text-danger">*</span></label>
