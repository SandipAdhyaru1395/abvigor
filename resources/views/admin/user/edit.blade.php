...
@section('content')
    <div class="admin container py-2">
        ...
        <div class="admin main-content p-4 table-responsive">
            <form class="mb-5" action="{{ route('admin.user.update') }}" method="POST">
                @csrf
                ...
                <div class="row mt-5">
                    ...
                    @if(!$user->deleted_at)
                        <div class="col text-end">
                            <a href="{{ route('admin.user.delete', $user->id) }}"><button type="button" id="delete-user" class="btn btn-sm btn-danger">Delete User</button></a>
                        </div>
                    @endif
                </div>
            </form>
