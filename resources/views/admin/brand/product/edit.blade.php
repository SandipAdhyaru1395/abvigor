        ...
        <div class="admin container-fluid py-2">
            ...
            <div class="admin main-content p-4">
                <div class="orders-card">
                    ...
                    <form class="mb-3" id="product-form" action="{{ route('admin.brand.product.update') }}" method="POST"
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col text-end">
                                <a href="{{ route('admin.brand.product.delete', $brand_product->id) }}">
                                    <button type="button" id="delete-brand" class="btn btn-danger">Delete Product</button>
                                </a>
                            </div>
                        </div>
                    </form>
