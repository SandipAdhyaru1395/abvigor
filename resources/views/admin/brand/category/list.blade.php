...
@section('content')
    <div class="admin container py-2">
        ...
        <div class="admin main-content p-4 table-responsive">
            <table id="brand-categories-table" class="table table-hover table-responsive table-striped table-bordered">
                <thead>
                    <tr>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table_top_left_html = `<div class="row mb-4">
                <div class="col">
                    <a href="{{ route('admin.brand.category.add') }}"><button class="btn btn-sm bg-primary text-white">Create</button></a>
