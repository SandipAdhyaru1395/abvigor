        ...
        <div class="admin container-fluid py-2">
            ...
            <div class="admin main-content p-4">
                <div class="orders-card">
                    ...
                    <form class="mb-3" action="{{ route('admin.brand.category.update') }}" method="POST">
                @csrf
                    ...
                    <div class="row mt-5">
                        ...
                        @if(!$brand_category->deleted_at)
                            <div class="col text-end">
                                <a href="{{ route('admin.brand.category.delete', $brand_category->id) }}">
                                    <button type="button" id="delete-brand-category" class="btn btn-danger">Delete Category</button>
                                </a>
                            </div>
                        @endif
                    </div>
